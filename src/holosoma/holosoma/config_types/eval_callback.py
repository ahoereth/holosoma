...
class RecordingConfig:
    ...
    record_motion_ref: bool = False
    """Record motion reference data from MotionCommand (time_steps, root, joints)."""

    note: str = ""
    """Free-form note stored in NPZ metadata (e.g. eval conditions)."""
