...
Pure numpy/cv2 (no rclpy): given a :class:`~holosoma.sensor_egress.base.FramePacket` array and a
...
Format → wire mapping (see ``ROS2ImageFormat`` in config_types/sensor_egress.py):
