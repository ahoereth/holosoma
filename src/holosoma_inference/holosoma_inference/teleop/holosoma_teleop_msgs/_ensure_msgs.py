...
_REQUIRED = ("ExoskeletonCmd", "ThreePointCmd", "Heartbeat", "SmplhCmd", "DenseTrackingCmd")
...
from holosoma_teleop_msgs.msg import DenseTrackingCmd, ExoskeletonCmd, Heartbeat, SmplhCmd, ThreePointCmd  # noqa: E402

__all__ = ["DenseTrackingCmd", "ExoskeletonCmd", "Heartbeat", "SmplhCmd", "ThreePointCmd"]
