...
**YOU ARE IN: `holosoma/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/holosoma/` (rig root) or other directories
...
**Your mail address:** `holosoma/polecats/furiosa`
**Your rig:** holosoma
**Your Witness:** `holosoma/witness`
...
| Ask Witness for help | `gt mail send holosoma/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`holosoma/witness`) when:
...
```bash
gt mail send holosoma/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
